...
export default function Footer() {
  return (
    <footer className="mt-10 border-t border-white/10 bg-gradient-to-b from-transparent to-black/30 md:mt-12">
      <div className="mx-auto max-w-7xl px-4 py-10">
        <div className="grid place-items-center gap-10 text-center md:grid-cols-4 md:place-items-start md:text-left">
          <div>
          ...
          <div>
            <h4 className="font-semibold text-white/90">Programs & Services</h4>
            <ul className="mt-3 space-y-2 text-white/80">
              ...
              <li>
                <Link href="/ai-websites" className="hover:text-white">
                  Website Development
                </Link>
              </li>
              <li>
                <Link href="/ai-social-media-marketing-training" className="hover:text-white">
                  Social Media Marketing
                </Link>
              </li>
              <li>
                <Link href="/ai-business-automation-training" className="hover:text-white">
                  Business Automation
                </Link>
              </li>
              <li>
                <Link href="/ai-market-research-funding-training" className="hover:text-white">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-white/80">
              ...
              <li>
                <a href="mailto:hello@kasiaihub.com" className="hover:text-white">
                  hello@kasiaihub.com
                </a>
              </li>
            </ul>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-white/10 pt-6 md:flex-row">
          <p className="text-xs text-white/60">© {new Date().getFullYear()} kasiAIhub. All rights reserved.</p>
