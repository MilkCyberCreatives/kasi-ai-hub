    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'No. We teach by example. If you can use email/WhatsApp, you can learn our workflows.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'A working workflow tailored to your goal, plus templates and a prompt library to reuse.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We focus on accessible tools and show free/low-cost options. We also cover data privacy.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes. Our Team Workshop is designed for small/medium teams with industry-specific examples.',
        },
      },
    ],
  };
